...
import { View, StatusBar, Text, Box, SafeAreaView, FlatList, TouchableOpacity } from 'react-native';
        ...
        <View style={commonStyle.container}>
            ...
            <SafeAreaView>
                <View style={commonStyle.header}>
                    ...
                    <AntDesign style={{ marginLeft: 200 }} name="logout" size={20} onPress={logout} />
                </View>
