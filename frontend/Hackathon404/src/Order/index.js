...
import { View, StatusBar, Text, Button, SafeAreaView, FlatList, TouchableOpacity } from 'react-native';
                ...
                {volatile.hideCart ? (<View><TouchableOpacity>
                    ...
                    <TouchableOpacity>
                        <View style={{ flexDirection: 'row' }}>
                            <Text style={styles.deleteWidth} onPress={deleteAll}>Delete</Text>
                            <Text style={styles.deleteWidth}>Save for later</Text>
                        </View>
                    </TouchableOpacity></View>) : (<Text style={commonStyle.successMessage} >
